...
*   **Unreal Engine:** Huge (~43 GiB), 3D focused, and C++ heavy thus unsuitable for rapid 2D prototyping.
...
*   **Magma:** Built on SDL2 for 2D rendering, with optional 3D via OpenGL (raylib)
